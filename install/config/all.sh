...
run_logged "${PACO_CONFIG}/default-browser.sh"
run_logged "${PACO_CONFIG}/environment-d.sh"
run_logged "${PACO_CONFIG}/chrome-new-window.sh"
run_logged "${PACO_CONFIG}/mimetypes.sh"
run_logged "${PACO_CONFIG}/icon-themes.sh"

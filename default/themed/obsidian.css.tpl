/* paco theme for Obsidian — colors injected from the active paco
 * theme's colors.toml at theme-switch time by bin/paco-theme-set-obsidian.
 * Layout/structure derived from the omarchy theme template. */
